	...
	double pi = M_PI;
        V_of_phi = modulus_params.overall_normalization * ((5.5699469787e-9*exp(-4.0*pow(sqrt(3.0),-1.0)*(phi_min+vars.phi))
							+ 41.8879020479*exp(-2.0*pi*exp(2.0*pow(sqrt(3.0),-1.0)*(phi_min+vars.phi)))*exp(-4.0*pow(sqrt(3.0),-1.0)*(phi_min+vars.phi))
							  *(-0.0002999999*exp(pi*exp(2.0*pow(sqrt(3.0),-1.0)))+10.0*(3.0+pi*exp(2.0*pow(sqrt(3.0),-1.0)*(phi_min+vars.phi))))));
        ...
        dVdphi = modulus_params.overall_normalization * (-1.2863241550e-8*exp(-4.0*pow(sqrt(3.0),-1.0)*(phi_min+vars.phi))
						      + 41.8879020479*exp(-2.0*pi*exp(2.0*pow(sqrt(3.0),-1.0)*(phi_min+vars.phi)))*exp(-4.0*pow(sqrt(3.0),-1.0)*(phi_min+vars.phi))
							*(36.2759872847*exp(2.0*pow(sqrt(3.0),-1.0))-0.0010882796*exp(pi*exp(2.0*pow(sqrt(3.0),-1.0)*(phi_min+vars.phi))))
						      - 96.7359660925*exp(-2.0*pi*exp(2.0*pow(sqrt(3),-1.0)*(phi_min+vars.phi)))*exp(-4.0*pow(sqrt(3.0),-1.0)*(phi_min+vars.phi))
                                                          *(-0.0002999999*exp(pi*exp(2.0*pow(sqrt(3.0),-1.0)))+10.0*(3.0+pi*exp(2.0*pow(sqrt(3.0),-1.0)*(phi_min+vars.phi))))
						      - 303.9050004140*exp(-2.0*pi*exp(2.0*pow(sqrt(3),-1.0)*(phi_min+vars.phi)))*exp(-2.0*pow(sqrt(3.0),-1.0)*(phi_min+vars.phi))
                                                          *(-0.0002999999*exp(pi*exp(2.0*pow(sqrt(3.0),-1.0)))+10.0*(3.0+pi*exp(2.0*pow(sqrt(3.0),-1.0)*(phi_min+vars.phi)))));
