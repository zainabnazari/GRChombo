#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Tue Nov 27 15:25:26 GMT 2018      
date_start=`date +%s`
...
export OMP_NUM_THREADS=4
 nice -n 10 /mnt/zfsusers/kclough/ForkedGRC/GRChombo/Examples/AxionCollapse/WithReflectiveBC/./jobscript 
