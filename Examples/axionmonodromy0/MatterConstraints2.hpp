...
#ifndef MATTERCONSTRAINTS2_HPP_
#define MATTERCONSTRAINTS2_HPP_
...
/*!
   ...
   ScalarField()
*/
template <class matter_t> class MatterConstraints2 : public Constraints
{
  public:
    ...
    /*!
       ...
       default.
    */
    MatterConstraints2(const matter_t a_matter, double dx,
                      double G_Newton = 1.0);
...
#include "MatterConstraints2.impl.hpp"

#endif /* MATTERCONSTRAINTS2_HPP_ */
